...
public class TestingSphere : MonoBehaviour
{
    ...
    private void HandlePetalsOpeningChanged(bool isOpening)
    {
        ...
        targetPosition = isOpening ? finalPosition.position : initialPosition.position;
        
    }

    private void HandleBadSmellEmittingChanged(bool isEmitting)
    {
        // Implement logic for bad smell emission
        StopAllCoroutines();
        StartCoroutine(ChangeColorGradually(isEmitting ? badSmellColor : idleColor));
